# -*- coding: utf-8 -*-
"""
Created on Fri Aug  4 20:25:30 2023
...
if __name__ == '__main__':
    ...
    df = pd.DataFrame(columns=["count", 'q', "attack", "time", "recovery"])
    ...
    with open(f"./pic_pkl/CLRZ{scenarios}{dataset}.pkl", "wb") as f:
        pickle.dump(df, f)
