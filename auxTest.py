# -*- coding: utf-8 -*-
"""
Created on Wed Jul 26 21:23:30 2023
...
if __name__ == '__main__':
    ...
    queryRate = 0.5  # Query proportion
    ...
    m = [2000, 3000, 5000, 7000, 10000, 12000, 15000] if dataset == "Enron" else [3000, 5000, 10000, 15000, 20000,
                                                                                  25000,
                                                                                  30000]
    ...
    for i_m, v_m in enumerate(m):
        for i_count in range(count):
            ...
            selectDocument = list(wordAccess.columns[np.random.permutation(num1)[:v_m]])
            ...
            M, N = utils.co_occurrence(A, B, v_m, num2)
            M_, N_ = utils.mutual_difference(A, B, v_m, num2)
    ...
    with open(f"./pic_pkl/Aux{scenarios}{dataset}.pkl", "wb") as f:
        pickle.dump(df, f)
